                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown"
                            ...
                            <?php if (!empty($mahasiswa['foto_profil'])): ?>
                                <img src="../uploads/<?= htmlspecialchars($mahasiswa['foto_profil']) ?>" class="profile-img"
                                    alt="Profile">
                            <?php else: ?>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card project-card">
                            <?php if (!empty($project['gambar'])): ?>
                                <img src="../uploads/<?= htmlspecialchars($project['gambar']) ?>" class="card-img-top"
                                    alt="Project Image">
                            <?php else: ?>
                                <img src="https://picsum.photos/seed/project<?= $project['id'] ?>/400/200.jpg" class="card-img-top"
                                    alt="Project Image">
                            <?php endif; ?>
